...
<c:if test="${not empty errorMsg }">
	...
	<div class="container">
		<div class="text-center mb-3" style="font-size: 30px">Add Musician to Band</div>
		<form action="submitAddMusicianToBand.do" method="POST">
		<input type="hidden" name="musicianId" value="${musician.id}">
			...
			<div class="input-group mb-3">
				<div class="input-group-prepend">
					<span class="input-group-text">Stage Name for Band</span>
				</div>
				<input class="form-control" type="text" required name="stageName"
