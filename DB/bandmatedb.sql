...
START TRANSACTION;
USE `bandmatedb`;
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (2, 1, 5, 'This show was so good!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (6, 1, 5, 'Amazing! Would see again!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (9, 1, 3, 'It was ok... Wish it was louder', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (14, 1, 4, 'Solid performance!!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (28, 1, 4, 'Excellent show!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (38, 1, 2, 'Their music is just not for me, I guess..', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (5, 3, 4, 'I looooove this band!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (9, 3, 5, 'Craziest stage show I\'ve ever seen. Not sure if it was a nightmare or a daydream', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (40, 3, 5, 'Please come back next year!!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (41, 3, 4, 'Unbelievable!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (44, 3, 5, 'Would give 6 stars if I could!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (33, 5, 4, 'What a smooth sound!! I could listen to this live every day.', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (21, 5, 3, 'Not a bad date night stop, not exceptional either.', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (29, 5, 5, 'I love the venue and the band, perfect night!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (50, 5, 4, 'They keep getting better and better!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (51, 5, 1, 'Total waste of money. I would rather listen to my toilet flushing on repeat all night.', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (36, 5, 3, 'Pretty good passion, but a bit repetative.', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (23, 5, 4, 'Didn\'t think I liked this kind of music so much, but they\'re turning me into a fan!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (7, 5, 2, 'Only thing good about this show was the venue.', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (8, 6, 5, 'Give me more!!!!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (11, 6, 5, 'If you haven\'t seen/heard this band, you NEED to check them out!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (14, 6, 4, 'Best show of the year so far!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (18, 8, 3, 'Not too bad, the musicians looked like they had a bit too much to drink...', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (20, 8, 2, 'The vibes were totally off on this one', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (30, 8, 4, 'I was getting pretty into it for a while. It dragged on a bit in the middle, but they killed it at the end!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (40, 8, 5, 'Sounded like a dream!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (41, 8, 3, 'Glad I went, but I think once is enough for me', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (5, 10, 4, 'Great show!!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (16, 10, 2, 'Not my taste, I should\'ve stayed home.', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (25, 10, 1, 'Total trash', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (38, 10, 5, 'Soooooo gooooood!!!!', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (47, 10, 3, 'Meh, could\'ve been better, but I guess it was music.', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (54, 10, 3, 'I liked it, did not love it', NULL);
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (11, 10, 4, 'Glad my friends dragged me out to this!', NULL);
