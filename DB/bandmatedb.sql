...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `phone`, `email`, `first_name`, `last_name`, `admin`, `date_of_birth`, `profile_image_url`, `bio`, `address_id`) VALUES (3, 'bandmateuser', '5678', 1, '333-111-9999', 'bandmateuser@bandmate.com', 'Sally', 'Limbs', 0, '1996-01-03', 'abc', 'My name is Sally and I looove music and concerts!! I use this website to let everybody know what bands are playing at what venues. I have been to over 600 concerts in my life so far and I don\'t plan on stopping anytime soon. I want to spread my love of music across the world and beyond!!!', NULL);
...
START TRANSACTION;
USE `bandmatedb`;
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (2, 1, 5, 'This show was so good!', '2022-01-17 14:37:14');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (6, 1, 5, 'Amazing! Would see again!', '2021-12-19 13:23:36');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (9, 1, 3, 'It was ok... Wish it was louder', '2022-03-31 13:30:10');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (14, 1, 4, 'Solid performance!!', '2022-01-05 07:42:39');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (28, 1, 4, 'Excellent show!', '2022-01-30 20:15:13');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (38, 1, 2, 'Their music is just not for me, I guess..', '2022-04-21 18:53:09');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (5, 3, 4, 'I looooove this band!', '2022-03-11 21:27:22');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (9, 3, 5, 'Craziest stage show I\'ve ever seen. Not sure if it was a nightmare or a daydream', '2022-05-04 21:30:18');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (40, 3, 5, 'Please come back next year!!', '2021-12-09 18:36:25');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (41, 3, 4, 'Unbelievable!', '2022-05-14 06:22:28');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (44, 3, 5, 'Would give 6 stars if I could!', '2021-12-29 23:22:55');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (33, 5, 4, 'What a smooth sound!! I could listen to this live every day.', '2021-12-05 11:18:42');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (21, 5, 3, 'Not a bad date night stop, not exceptional either.', '2021-10-19 23:04:07');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (29, 5, 5, 'I love the venue and the band, perfect night!', '2022-01-24 18:49:34');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (50, 5, 4, 'They keep getting better and better!', '2022-02-23 07:09:47');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (51, 5, 1, 'Total waste of money. I would rather listen to my toilet flushing on repeat all night.', '2022-03-06 21:19:23');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (36, 5, 3, 'Pretty good passion, but a bit repetative.', '2021-10-29 10:02:52');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (23, 5, 4, 'Didn\'t think I liked this kind of music so much, but they\'re turning me into a fan!', '2022-04-07 15:38:57');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (7, 5, 2, 'Only thing good about this show was the venue.', '2021-10-04 00:11:04');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (8, 6, 5, 'Give me more!!!!', '2022-04-20 19:58:04');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (11, 6, 5, 'If you haven\'t seen/heard this band, you NEED to check them out!', '2022-03-10 06:04:43');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (14, 6, 4, 'Best show of the year so far!', '2022-01-25 18:55:18');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (18, 8, 3, 'Not too bad, the musicians looked like they had a bit too much to drink...', '2022-04-27 10:29:02');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (20, 8, 2, 'The vibes were totally off on this one', '2021-11-02 02:18:49');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (30, 8, 4, 'I was getting pretty into it for a while. It dragged on a bit in the middle, but they killed it at the end!', '2021-12-25 23:52:58');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (40, 8, 5, 'Sounded like a dream!', '2022-02-09 11:20:52');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (41, 8, 3, 'Glad I went, but I think once is enough for me', '2022-01-29 09:38:48');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (5, 10, 4, 'Great show!!', '2021-10-11 18:34:03');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (16, 10, 2, 'Not my taste, I should\'ve stayed home.', '2022-01-15 03:36:48');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (25, 10, 1, 'Total trash', '2022-02-21 14:50:41');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (38, 10, 5, 'Soooooo gooooood!!!!', '2022-03-27 07:49:37');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (47, 10, 3, 'Meh, could\'ve been better, but I guess it was music.', '2021-10-22 05:51:31');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (54, 10, 3, 'I liked it, did not love it', '2021-11-22 23:51:10');
INSERT INTO `performance_review` (`user_id`, `performance_id`, `rating`, `rating_comment`, `review_date`) VALUES (11, 10, 4, 'Glad my friends dragged me out to this!', '2022-04-21 11:37:33');
